...
/**
 * Provides basic form that will be loaded via controller.
 *
 * This form is displayed as page content.
 * Route name for this form `cdp_forms.page.basic`
 *
 * @link http://cdp.docker.localhost/development/forms/pages/basic
 *
 * Route name for this form `cdp_forms.page.basic_with_elements`
 *
 * @link http://cdp.docker.localhost/development/forms/pages/basic-with-elements
 */
class BasicFormInController extends FormBase {
